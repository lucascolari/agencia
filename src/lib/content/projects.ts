...
const projects: Project[] = [
  ...
  },
  {
    ...
    summary: "Propuesta creativa y CGI para la marca.",
    cover: localImage("motorola", 1, "Propuesta Motorola CGI", "high"),
    layout: "full",
    featured: true,
    caseStudy: {
      challenge: "Proponer un universo visual con impacto y ambición.",
      strategy: "Dirección de arte y desarrollo de la propuesta con CGI.",
      services: ["Dirección de arte", "CGI", "Diseño"],
      blocks: [localGallery("motorola", 6, "Propuesta Motorola")],
