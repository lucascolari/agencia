...
const csp = [
  ...
  "img-src 'self' data: blob: https://res.cloudinary.com https://image.mux.com",
  "media-src 'self' blob: https://stream.mux.com https://*.mux.com https://*.fastly.mux.com",
  "font-src 'self' data:",
  `connect-src 'self' https://stream.mux.com https://*.mux.com https://*.fastly.mux.com https://*.litix.io${isDev ? " ws: http: https:" : ""}`,
